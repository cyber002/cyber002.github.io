...
const services = [
	...
	{ name: 'cnflix影视', icon: 'cnflix', url: 'https://www.cnflix.tv/', action: 'select', requiresCodec: true },
  { name: '量子资源站', icon: 'liangzi', url: 'https://lzizy.net/', action: 'select', requiresCodec: true },
